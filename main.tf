...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "omer"
    security_groups = ["omergo-docker-sec-gr-203"] # !!!!!!!!!!!!
    tags = {
        Name = "omergo-Web Server of Bookstore"
    }
    user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          FOLDER="https://$TOKEN@raw.githubusercontent.com/omergokkaya/bookstore-repo/main/"
